    ...
    >
      ...
      <section ref={heroRef} id="hero" style={{ minHeight: "100dvh", display: "flex", alignItems: "center", overflow: "hidden", padding: "80px 20px" }}>
        ...
        <div className="container-x relative z-10 text-center">
          ...
          >
            Tu Mente No Para. Ni <span style={{ color: "#D4AF37" }}>Noche ni de Día</span>. Este Sistema <span style={{ color: "#D4AF37" }}>la Apaga en 7 Minutos</span>.
          </h1>
          <p
          ...
          >
            El mismo protocolo de audio que usan miles de personas en México para apagar el ruido mental en 7 minutos — <span style={{ color: "#D4AF37" }}>sin meditación, sin pastillas, sin esfuerzo.</span>
          </p>
          <div
      ...
      <section style={{ background: "linear-gradient(180deg,#06060F 0%, rgba(107,33,200,0.15) 50%, #06060F 100%)" }}>
        <div className="container-x text-center">
          ...
          <Reveal delay={0.25}>
            <p className="mt-10">Esta noche puedes dormir diferente.</p>
            <p className="font-cinzel mt-1" style={{ color: "#D4AF37" }}>O cerrar esta página y seguir igual.</p>
          </Reveal>
        </div>
      </section>
